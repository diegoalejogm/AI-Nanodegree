...
def cnn_rnn_model(input_dim, filters, kernel_size, conv_stride,
    ...
    # Add batch normalization
    bn_rnn = BatchNormalization(name='bn_recur')(simp_rnn)
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    #    Add batch normalization
    bn_rnn_1 = BatchNormalization()(simp_rnn_1)
...
def final_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn2 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn'), merge_mode='concat')(bidir_rnn1)
...
## OPTIONAL MODELS
def cnn_rnn_gru(input_dim, filters, kernel_size, conv_stride,
    conv_border_mode, units, output_dim=29):
    """ Build a recurrent + convolutional network for speech 
    """
    # Main acoustic input
...
def deep_bidirectional(input_dim, units, output_dim=29):
    # Main acoustic input
    input_data = Input(name='the_input', shape=(None, input_dim))
    # TODO: Specify the layers in your network
...
def deep_bidirectional_normalized(input_dim, units, output_dim=29):
    # Main acoustic input
    input_data = Input(name='the_input', shape=(None, input_dim))
    # TODO: Specify the layers in your network
    ...
    # Add bidirectional recurrent layer
    bidir_rnn2 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn'), merge_mode='concat')(bn_rnn1)
